...
function Header() {
  ...
  return (
    <header className="container mx-auto md:flex justify-between py-2 max-width">
      <div className="flex justify-between items-center py-15 md:py-7">
        <NavLink to="/">
          <img className="w-20" src={logos.logogradient} alt="logo" />
        </NavLink>
        <div className="text-2xl font-bold text-white ml-4">Trio Bencana</div>
        <div onClick={toggleClass} className="cursor-pointer ml-auto">
          <svg
