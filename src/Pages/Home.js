  ...
  return (
    <main className="container mx-auto max-width pt-2 pb-20">
      <h2 
        ...
        className="text-xl text-center text-dark-heading dark:text-light-heading md:text-3xl xl:text-4xl xl:leading-tight font-bold about-text moving-gradient" style={{backgroundImage: "linear-gradient(45deg, #00ff00, #FFA500, #00ff00, #00ff00)", backgroundSize: "300%", WebkitBackgroundClip: "text", backgroundClip: "text", WebkitTextFillColor: "transparent"}}
      >
        Cloud Computing
        <br></br>
        <br></br>
      ...
      {personalDetails.map((person, index) => (
        <div key={index} className="md:flex justify-between items-center mb-20">
          <div className="flex flex-col items-start">
            ...
            <div className="flex flex-col items-start">
              ...
              <span
                ...
                className="text-lg text-dark-heading dark:text-light-heading md:text-xl xl:text-2xl mt-2"
              >
                {person.kelas}
              </span>
            </div>
          ...
          <div className="mt-5 md:mt-0">
            <img ref={(el) => (imageRefs.current[index] = el)} className="w-1/2 md:ml-auto" src={person.img} alt={person.name} />
          </div>
        </div>
      ))}
    </main>
